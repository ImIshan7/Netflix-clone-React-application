...
import './custom.css';
import user from '../images/NetflixTV.png';
    ...
    render() {
        return (
            <>
                ...
                <div>
                    <div id="background" className="h-screen flex justify-center items-center bg-cover bg-center">

                        <div className="absolute top-0 left-0 mt-5 ml-5">
                            <svg viewBox="0 0 111 30" fill="#e50914" className="w-28" focusable="false">
                        ...
                        <button className=" rounded-md absolute bg-red-600 hover:bg-red-700  font-bold text-white p-3 top-0 right-0 mt-3 mr-5">Sign In</button>
                        <div className="space-y-5">
                            ...
                            <div className="flex flex-row items-center justify-center">
                                <input type="text" placeholder="Email address" className="p-4 focus:outline-none focus:ring-1 focus:ring-blue-300 w-3/4" />
                                <button className="p-4 text-l font-semibold bg-red-600 hover:bg-red-700 text-white">Get Started </button>
                            </div>
                        </div>
                    </div>
                    <hr />
                    ...
                    <div className="min-h-screen bg-black space-y-10">
                        ...
                        <div className="space-y-5 flex flex-col justify-center items-center">
                            <div className=" rounded-md p-5 bg-[#303030] w-3/4">
